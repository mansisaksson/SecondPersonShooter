...
FText SScalabilityUIPanel::GetResolutionScaleString() const
{
	return FText::FromString(FString::Printf(TEXT("%1.1fx"), ((float)CachedQualityLevels.ResolutionQuality / Scalability::MaxResolutionScale)));
}
